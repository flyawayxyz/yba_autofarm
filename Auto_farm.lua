game.StarterGui:SetCore("SendNotification", {Title="Flyaway.xyz"; Text="Auto Farm Loaded!"; Duration=5;})
getgenv().standList =  {
    ["The World"] = true,
    ["Star Platinum"] = true,
...
getgenv().webhook = "https://discord.com/api/webhooks/1312041393874800762/-DKzlgeHrRwQaFGB7flWst4bqEPdn_fpIcL1KV-AqGrWPF92DxmbUyytBAnB1n6S1bmu" --change this if u want to use ur own webhook
...
local function SendWebhook(msg)
    ...
    data = {
        ["embeds"] = {
            {
                ["title"] = "Flyaway.xyz - Auto Prestige 3",
                ["description"] = msg,
                ["type"] = "rich",
                ["color"] = tonumber(0xFFB6C1),
            }
        }
    }
